...
class Ui_ventPrincipal(object):
    def setupUi(self, ventPrincipal):
        ...
        self.gridLayout_6.addWidget(self.lblCodCli, 2, 1, 1, 1)
        ...
        self.tablaCli.horizontalHeader().setStretchLastSection(False)
        ...
        self.spinBox = QtWidgets.QSpinBox(self.tab_11)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"background-color: qlineargradient(spread:pad, x1:0.545, y1:0.482955, x2:0.534091, y2:1, stop:0 rgba(38, 78, 203, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        self.gridLayout.addWidget(self.lblFecha, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnCalendar, 0, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.editClialta, 0, 5, 1, 1)
...
"background-color: qlineargradient(spread:pad, x1:0.545, y1:0.482955, x2:0.534091, y2:1, stop:0 rgba(38, 78, 203, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        spacerItem6 = QtWidgets.QSpacerItem(300, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/BackUp/backup.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.toolbarBackUp.setIcon(icon1)
        self.toolbarBackUp.setObjectName("toolbarBackUp")
        self.ToolbarSalir = QtWidgets.QAction(ventPrincipal)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/toolbarSalir/iconsalir.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.ToolbarSalir.setIcon(icon2)
        self.ToolbarSalir.setObjectName("ToolbarSalir")
        self.toolbarCarpeta = QtWidgets.QAction(ventPrincipal)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/iconcarpeta/iconcarpeta.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        self.toolbarCarpeta.setIcon(icon3)
